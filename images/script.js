...
if ($("#wish-form").length) {
    $("#wish-form").validate({
        ...
        messages: {
            ...
            email: {
                email: 'Vui lòng chọn xác nhận tham dự.'
            }
        },
            ...
            $.ajax({
                ...
                success: function (res) {
                    ...
                    if(!res.error){
                        ...
                        console.log(form);
                        $('.wish-box').prepend('<div class="wish-box-item bg"><strong>'+$(form).find("input[name='name']").val().replace(/&/g, "&amp;").replace(/>/g, "&gt;").replace(/</g, "&lt;").replace(/"/g, "&quot;").replace(/(\r\n|\n|\r)/gm, "")+'</strong><p>'+$(form).find("textarea[name='content']").val().replace(/&/g, "&amp;").replace(/>/g, "&gt;").replace(/</g, "&lt;").replace(/"/g, "&quot;").replace(/(\r\n|\n|\r)/gm, "")+'</p><p class="comment-confirm">'+$(form).find("select[name='confirm']").val().replace(/&/g, "&amp;").replace(/>/g, "&gt;").replace(/</g, "&lt;").replace(/"/g, "&quot;").replace(/(\r\n|\n|\r)/gm, "")+'</p></div>');
